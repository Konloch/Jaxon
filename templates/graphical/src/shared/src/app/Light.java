...
public class Light
{
	 ...
	 * @param v    the position or direction
	 * @param r    red light color, from 0 to 1
	 * @param g    green light color, from 0 to 1
	 * @param b    blue light color, from 0 to 1
	 */
	public Light(int type, app.Vector3f v, float r, float g, float b)
	{
		lightType = type;
		ir = r;
		ig = g;
