...
public class Triangle extends Renderable
{
	 ...
	 */
	public app.Vector3f point1, point2, point3;
	
	public Triangle(Surface s, app.Vector3f v1, app.Vector3f v2, app.Vector3f v3)
	{
		surface = s;
		point1 = v1;
		point2 = v2;
	 ...
	 */
	public long Shade(Ray ray, Scene scene, app.Vector3f t1, app.Vector3f t2, app.Vector3f t3)
	{
		...
		l1 = (ray.origin.x - px - nx) * (ray.origin.x - px - nx) + (ray.origin.y - py - ny) * (ray.origin.y - py - ny) + (ray.origin.z - pz - nz) * (ray.origin.z - pz - nz);
		l2 = (ray.origin.x - px + nx) * (ray.origin.x - px + nx) + (ray.origin.y - py + ny) * (ray.origin.y - py + ny) + (ray.origin.z - pz + nz) * (ray.origin.z - pz + nz);
		if (l2 < l1)
		{
