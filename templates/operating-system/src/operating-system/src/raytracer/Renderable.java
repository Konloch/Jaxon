...
public abstract class Renderable
{
	 ...
	 *
	 * @param Ray to check against the object
	 ...
	 * @param three temporary vectors (are changed in method!)
	 * @return RGBfCol shading color
	 */
	public abstract long Shade(Ray r, Scene scene, Vector3f t1, Vector3f t2, Vector3f t3);
