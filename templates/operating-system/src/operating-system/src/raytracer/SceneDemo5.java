...
public class SceneDemo5 extends Scene
{
	...
	private void createWalls()
	{
		...
		s = new Surface(0.5f, 0.45f, 0.35f, 0.07f, 1.0f, 0.8f, 3.0f, 0.5f, 0.0f, 1.0f);
	...
	{
		objects.addElement(new Sphere(cS, new Vector3f(x + 0.0f, y + 0.0f, 0.5f), 0.5f));
		objects.addElement(new Sphere(cS, new Vector3f(x + 0.643951f, y + 0.172546f, 0.5f), 0.166667f));
		objects.addElement(new Sphere(cS, new Vector3f(x + 0.172546f, y + 0.643951f, 0.5f), 0.166667f));
		objects.addElement(new Sphere(cS, new Vector3f(x - 0.471405f, y + 0.471405f, 0.5f), 0.166667f));
		objects.addElement(new Sphere(cS, new Vector3f(x - 0.643951f, y - 0.172546f, 0.5f), 0.166667f));
		objects.addElement(new Sphere(cS, new Vector3f(x - 0.172546f, y - 0.643951f, 0.5f), 0.166667f));
		objects.addElement(new Sphere(cS, new Vector3f(x + 0.471405f, y - 0.471405f, 0.5f), 0.166667f));
		if (upper)
		{
			objects.addElement(new Sphere(cS, new Vector3f(x + 0.272166f, y + 0.272166f, 1.044331f), 0.166667f));
			objects.addElement(new Sphere(cS, new Vector3f(x - 0.371785f, y + 0.0996195f, 1.044331f), 0.166667f));
			objects.addElement(new Sphere(cS, new Vector3f(x - 0.0996195f, y - 0.371785f, 1.044331f), 0.166667f));
		}
	}
	...
	private void createThings()
	{
		...
		objects.addElement(new Cylinder(s, new Vector3f(3.0f, -1.8f, 1.2f), 0.35f, new Vector3f(-3.0f, 1.6f, 0.3f), false));
	...
	private void createLights()
	{
		...
		lights.addElement(new Light(Light.POINT, new Vector3f(10.0f, -3.0f, 10.0f), 0.8f, 0.8f, 0.8f));
		lights.addElement(new Light(Light.POINT, new Vector3f(0.0f, 0.0f, 2.0f), 0.3f, 0.3f, 0.3f));
	}
