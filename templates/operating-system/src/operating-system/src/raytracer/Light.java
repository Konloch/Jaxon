...
public class Light
{
	 ...
	 *
	 * @param int      the type of light
	 * @param Vector3f the position or direction
	 * @param float    red light color, from 0 to 1
	 * @param float    green light color, from 0 to 1
	 * @param float    blue light color, from 0 to 1
	 */
