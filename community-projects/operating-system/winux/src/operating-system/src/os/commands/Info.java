...
public class Info extends CommandTask
{
	...
	{
		out.print("Image start     : ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase));
		out.println();
		out.print("Image size      : ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 4));
		out.println();
		out.print("Class deskr     : ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 8));
		out.println();
		out.print("First code byte : ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 12));
		out.println();
		out.print("First object    : ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 16));
		out.println();
		out.print("RAM-init address: ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 20));
		out.println();
		out.print("Relative code st: ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 24));
		out.println();
		out.print("lo hi relocBytes: ");
		out.printHex(MAGIC.rMem32(MAGIC.imageBase + 28));
		out.println();
	}
