...
public class BIOS
{
	...
	public static void rint(int inter)
	{
		...
		Interrupts.writeIDTR(); //load idt with protected/long mode interrupt table
		MAGIC.inline(0x9D); //popf
	}
	
	private static void lidtRM()
	{
		long tmp = 1023;
	...
	//enters 320x200 256 colors mode
