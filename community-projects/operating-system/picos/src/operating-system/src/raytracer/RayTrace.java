...
public class RayTrace
{
	...
	public void init(int w, int h)
	{
		...
		look = new Vector3f(scene.lookat.x - scene.eye.x, scene.lookat.y - scene.eye.y, scene.lookat.z - scene.eye.z);
		crossp = new Vector3f();
	...
	public void renderLine(int[] dest, CalcTAinfo cTAi)
	{
		...
		if (cTAi.var1 != null)
			dir = (Vector3f) cTAi.var1;
		else
			cTAi.var1 = dir = new Vector3f();
		if (cTAi.var2 != null)
			ray = (Ray) cTAi.var2;
		else
			cTAi.var2 = ray = new Ray(scene.eye, dir);
		if (cTAi.var3 != null)
			t1 = (Vector3f) cTAi.var3;
		else
			cTAi.var3 = t1 = new Vector3f();
		if (cTAi.var4 != null)
			t2 = (Vector3f) cTAi.var4;
		else
			cTAi.var4 = t2 = new Vector3f();
		if (cTAi.var5 != null)
			t3 = (Vector3f) cTAi.var5;
		else
			cTAi.var5 = t3 = new Vector3f();
