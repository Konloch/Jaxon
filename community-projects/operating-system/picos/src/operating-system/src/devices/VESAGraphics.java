...
public class VESAGraphics extends VGAText
{
	...
	private final static VESAControllerInfoStruct contrInfo = (VESAControllerInfoStruct) MAGIC.cast2Struct(KernelConst.KM_SCRATCH);
	private final static VESAModeInfoStruct modeInfo = (VESAModeInfoStruct) MAGIC.cast2Struct(KernelConst.KM_SCRATCH);
	...
	public static VESAGraphics detectDevice()
	{
		...
		//check signatures
		if ((MAGIC.rMem16(BIOS.EAX)) != (short) 0x004F)
			return null;
