 ...
 */
public class Font7x8 extends AFont
{
	...
	private static final byte[] FONT_BYTES = {0, 0, 0, 0, 0, 0, 0, // ' ' 32
			0, 6, 95, 95, 6, 0, 0, // '!' 33
			0, 7, 7, 0, 7, 7, 0, // '"' 34
			...
			8, 8, 62, 62, 8, 8, 0, // '+' 43
			0, (byte) 128, (byte) 224, 96, 0, 0, 0, // ',' 44
			8, 8, 8, 8, 8, 8, 0, // '-' 45
			0, 0, 96, 96, 0, 0, 0, // '.' 46
			...
			0, (byte) 128, (byte) 230, 102, 0, 0, 0, // ';' 59
			...
			8, 12, 6, 3, 6, 12, 8, // '^' 94
			(byte) 128, (byte) 128, (byte) 128, (byte) 128, (byte) 128, (byte) 128, (byte) 128, // '_' 95
			0, 0, 3, 7, 4, 0, 0, // '`' 96
			...
			56, (byte) 188, (byte) 164, (byte) 164, (byte) 252, 120, 0, // 'g' 103
			65, 127, 127, 8, 4, 124, 120, // 'h' 104
			0, 68, 125, 125, 64, 0, 0, // 'i' 105
			96, (byte) 224, (byte) 128, (byte) 128, (byte) 253, 125, 0, // 'j' 106
			...
			0, (byte) 252, (byte) 252, (byte) 164, 36, 60, 24, // 'p' 112
			24, 60, 36, (byte) 164, (byte) 248, (byte) 252, (byte) 132, // 'q' 113
			...
			60, (byte) 188, (byte) 160, (byte) 160, (byte) 252, 124, 0, // 'y' 121
