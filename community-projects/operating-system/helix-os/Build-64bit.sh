#!/bin/bash
jaxon "sjc-env" "operating-system" "BOOT_FLP.IMG" "build.img" "-t" "amd64" "-o" "raw" "-O" "BOOT_FLP.IMG" "-s" "10000M" "-T" "nsop" "-u" "rte" "-y" "-g" "-G" "-n" "src/shared/src" "src/operating-system/src"
