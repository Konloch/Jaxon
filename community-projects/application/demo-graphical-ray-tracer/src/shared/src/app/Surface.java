...
public class Surface
{
	 ...
	 *
	 * @param rval  rval red
	 * @param gval  gval green
	 * @param bval  bval blue
	 * @param a     a ambient coefficient
	 * @param d     d diffuse coefficient
	 * @param s     s specular coefficient
	 * @param n     n shininess
	 * @param r     r reflectivity
	 * @param t     t transparency
	 * @param index nt refractive index
	 */
	 ...
	 *
	 * @param t1    p the point of intersection
	 * @param t2    n the unit-length surface normal
	 * @param t3    v the unit-length vector towards the ray origin
	 * @param scene lights, objects, color
	 * @return RGBfCol the color of the surface at the intersection pt
	 */
	public long Shade(app.Vector3f t1, app.Vector3f t2, app.Vector3f t3, Scene scene, Ray tempRay)
	{
