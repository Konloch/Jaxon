...
public class DynamicRuntime
{
	...
	{ //change to Object if interface arrays are used
		return null;
	}
	
	public static void newMultArray(SArray[] parent, int curLevel, int destLevel, int length, int arrDim, int entrySize, int stdType, SClassDesc unitType)
	{
	...
	public static boolean isArray(SArray o, int stdType, SClassDesc unitType, int arrDim, boolean asCast)
	{ //change unitType to Object if interface arrays are used
		return false;
	}
}
